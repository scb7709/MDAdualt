...
public class SetPassWordActivity extends BaseActivity {
    ...
    private void getSMS(final String phone) {
       ...
       /* RequestParams params = new RequestParams(Constant.BASE_URL + "/MdMobileService.ashx?do=GetSendMessageRequest&version=v2.9.6");
        ...
        HttpUtils.getInstance(SetPassWordActivity.this).sendRequestRequestParams("正在获取手机验证码,请稍后...", params, true, new HttpUtils.ResponseListener() {
            @Override
            public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (IsSuccess.equals("true")) {
                                ...
                                Toast.makeText(SetPassWordActivity.this, jsonObject.getString("Message"), Toast.LENGTH_SHORT).show();
                               *//* if (Status.equals("3")) {
