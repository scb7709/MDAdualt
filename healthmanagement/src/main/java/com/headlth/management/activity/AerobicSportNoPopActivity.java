...
public class AerobicSportNoPopActivity extends BaseActivity implements View.OnClickListener/*, IWeiboHandler.Response*/ {
    ...
    private int fifteen_minutes = -1;//15分钟倒计时
...
/*
    ...
    private void KeepTime() {
        if (con_state == -1) {//热身阶段
            ...
            } else if (fifteen_minutes >= 15 * 60) {//暂停超过15分钟自动上传
                overTask();
    ...
    public Handler h = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1001) {//记录心率 设置游标移动
                ...
                MyToash.Toash(activity, "上传成功");

            } else if (msg.what == 8) {
                MyToash.Toash(activity, "上传失败");
