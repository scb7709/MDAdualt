...
public interface OSS {
     ...
     * @throws ClientException
     */
    String presignConstrainedObjectURL(String bucketName, String objectKey, long expiredTimeInSeconds)
            throws ClientException;
     ...
     * @return
     */
    String presignPublicObjectURL(String bucketName, String objectKey);
