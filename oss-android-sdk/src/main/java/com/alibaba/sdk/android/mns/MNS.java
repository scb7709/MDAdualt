...
public interface MNS {
     ...
     *  Create Queue用于创建队列。
     */
    MNSAsyncTask<CreateQueueResult> asyncCreateQueue(
     ...
     * Delete Queue用于删除队列。
     */
    MNSAsyncTask<DeleteQueueResult> asyncDeleteQueue(
     ...
     * 异步设置队列属性
     */
    MNSAsyncTask<SetQueueAttributesResult> asyncSetQueueAttributes(
     ...
     * 异步获取队列属性
     */
    MNSAsyncTask<GetQueueAttributesResult> asyncGetQueueAttributes(
     ...
     * 异步列出队列列表
     */
    MNSAsyncTask<ListQueueResult> asyncListQueue(
            ListQueueRequest request, MNSCompletedCallback<ListQueueRequest, ListQueueResult> completedCallback);

    /**
     * 同步列出队列列表
     */
    ListQueueResult listQueue(ListQueueRequest request)
            throws ClientException, ServiceException;

    /**
     * 异步发送消息
     */
    MNSAsyncTask<SendMessageResult> asyncSendMessage(
     ...
     * 异步接收消息
     */
    MNSAsyncTask<ReceiveMessageResult> asyncReceiveMessage(
     ...
     * 异步删除消息
     */
    MNSAsyncTask<DeleteMessageResult> asyncDeleteMessage(
     ...
     * 异步查看消息
     */
    MNSAsyncTask<PeekMessageResult> asyncPeekMessage(
            PeekMessageRequest request, MNSCompletedCallback<PeekMessageRequest, PeekMessageResult> completedCallback);

    /**
     * 同步查看消息
     */
    PeekMessageResult peekMessage(PeekMessageRequest request)
            throws ClientException, ServiceException;

    /**
     * 异步修改消息可见时间
     */
    MNSAsyncTask<ChangeMessageVisibilityResult> asyncChangeMessageVisibility(
